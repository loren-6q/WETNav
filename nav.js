...
<style>
  ...
  .dropdown-content { display: none; position: absolute; background: whitconst navStyle = `
<style>
  #global-nav { background: #37b5ff !important; color: white !important; font-family: sans-serif; position: fixed; top: 0; left: 0; width: 100%; z-index: 999999; display: flex; justify-content: space-between; align-items: center; padding: 0 15px; height: 40px; box-sizing: border-box; border-bottom: 2px solid rgba(0,0,0,0.1); }
  .nav-logo { display: flex; align-items: center; gap: 8px; text-decoration: none; color: white !important; font-weight: 800; font-size: 16px; height: 100%; }
  .nav-logo img { height: 28px; width: auto; border-radius: 3px; display: block; }
...
const renderNav = () => {
        ...
        html += `
            <div class="nav-item">
              ...
              <div class="dropdown-content">
                <a href="${fix('https://wetsalaries.netlify.app/')}" data-type="admin" data-icon="💰" data-desc="Review and manage staff payroll and commissions.">Salaries</a>
                <a href="${fix('https://loren-6q.github.io/WETParser/')}" data-type="admin" data-icon="📑" data-desc="Convert CSV and booking data into usable formats.">Parser</a>
                <a href="#" data-type="admin" data-icon="🏦" data-desc="WET internal accounting and expense tracking.">Accounting</a>
              </div>
            </div>`;
    }
    ...
    if (user === 'BOSS' || user === 'REC') {
        html += `
            <div class="nav-item">
              ...
              <div class="dropdown-content">
                <a href="https://inbox.myallocator.com/booknow/-sxO1cCV5jLMwqZTXY629A" target="_blank" data-type="sys-front" data-icon="🏨" data-desc="Direct booking engine for public-facing rates.">WET Booking Engine</a>
                <a href="https://www.booking.com/searchresults.en-gb.html?dest_id=900050772&dest_type=city" target="_blank" data-type="sys-front" data-icon="🔵" data-desc="Live competitor pricing and availability search.">B.com Search</a>
                <a href="https://www.hostelworld.com/pwa/s?q=Koh%20Phangan" target="_blank" data-type="sys-front" data-icon="🟠" data-desc="Hostelworld marketplace monitoring.">HW Search</a>
              </div>
            </div>`;
    }
    ...
    if (user === 'BOSS' || user === 'REC') {
        html += `
            <div class="nav-item">
              ...
              <div class="dropdown-content">
                <a href="https://sg.loventis.net/Reception" target="_blank" data-type="sys-back" data-icon="🏩" data-desc="Front desk management and check-in portal.">Loventis (PMS)</a>
                <a href="https://inbox.myallocator.com/en/availability/58137" target="_blank" data-type="sys-back" data-icon="🔑" data-desc="Inventory sync and channel management.">MyAllocator</a>
                <a href="https://docs.google.com/spreadsheets/d/1UqivgGUjV0JAO2vB4QFjdw0c62pSsdlMsna-z4xE_SQ/edit?usp=sharing" target="_blank" data-type="sys-back" data-icon="💸" data-desc="Master sheet for tracking refund requests.">Refundability</a>
                <a href="https://account.booking.com/sign-in" target="_blank" data-type="sys-back" data-icon="🛂" data-desc="Manage B.com extranet and property settings.">B.com Login</a>
                <a href="https://inbox.hostelworld.com/" target="_blank" data-type="sys-back" data-icon="🛂" data-desc="Manage HW extranet and booking backlogs.">HW Login</a>
              </div>
            </div>`;
    }
    ...
    if (user === 'BAR' || user === 'BOSS') {
         html += `<div class="nav-item"><a href="${fix('https://bar-stock-nine.vercel.app/')}" data-type="ops" data-icon="🍺" data-desc="Bar inventory control and stock take system.">Stock</a></div>`;
    }
    
    // 5. SHARED
    html += `<div class="nav-item"><a href="${fix('https://loren-6q.github.io/WETvCal/')}" data-type="ops" data-icon="🗓️" data-desc="Event calendar and venue booking schedule.">V Cal</a></div>`;
    html += `<div class="nav-item"><a href="${fix('https://loren-6q.github.io/Full-Moon-Week-Schedule/')}" data-type="ops" data-icon="🌕" data-desc="Master shift and event schedule for FMW.">FMW</a></div>`;
...
renderNav();e; min-width: 180px; top: 40px; left: 0; box-shadow: 0 4px 10px rgba(0,0,0,0.2); border-radius: 0 0 4px 4px; border: 1px solid #ddd; }
  .dropdown-content a { color: #333 !important; border-bottom: 1px solid #eee; padding: 10px 15px; height: auto !important; display: block !important; }
  .dropdown-content a:hover { background: #f0f0f0; color: #37b5ff !important; }
  .nav-item:hover .dropdown-content { display: block; }
  @media (max-width: 950px) {
