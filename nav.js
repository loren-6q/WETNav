...
const renderNav = () => {
    ...
    if (user === 'BOSS' || user === 'REC') {
        html += '<div class="nav-item"><span class="drop-btn">฿ Price Checks ▾</span><div class="dropdown-content">' +
    ...
    if (user === 'BAR' || user === 'BOSS') {
         html += '<div class="nav-item"><a href="' + fix('https://bar-stock-nine.vercel.app/') + '" data-type="ops" data-icon="🍺" data-desc="Bar & Hostel stock check, ordering, and inventory.">Stock</a></div>';
    }
    
    // 5. SHARED
    html += '<div class="nav-item"><a href="' + fix('https://loren-6q.github.io/WETvCal/') + '" data-type="ops" data-icon="🗓️" data-desc="Calendar for stay dates of temp workers.">V Cal</a></div>';
    html += '<div class="nav-item"><a href="' + fix('https://loren-6q.github.io/Full-Moon-Week-Schedule/') + '" data-type="ops" data-icon="🌕" data-desc="Full Moon Week Instagram publishing tool.">FMW</a></div>';
