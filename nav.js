        ...
        html += `
            <div class="nav-item">
              ...
              <div class="dropdown-content">
                <a href="${fix('https://wetsalaries.netlify.app/')}" data-type="app">Salaries & Payroll</a>
                <a href="${fix('https://loren-6q.github.io/WETParser/')}" data-type="app">Parser Tool</a>
        ...
        html += `
            <div class="nav-item">
              ...
              <div class="dropdown-content">
                ...
                <a href="https://www.booking.com/searchresults.en-gb.html?dest_id=900050772&dest_type=city&checkin=2026-12-31&checkout=2027-01-01&group_adults=1&no_rooms=1&group_children=0&order=price" target="_blank" data-type="link">Booking.com</a>
                <a href="https://www.hostelworld.com/pwa/s?q=Koh%20Phangan..." target="_blank" data-type="link">Hostelworld</a>
              </div>
            </div>
            <div class="nav-item">
