...
const renderNav = () => {
    ...
    if (user === 'BOSS') {
        let items = `<a href="https://inbox.myallocator.com/en/availability/58137" target="_blank" data-type="admin" data-icon="🌐" data-desc="Channel manager syncing." data-manual="Link to WET's Channel Manager, MyAllocator">MyAllocator</a>` +
                    `<a href="https://account.booking.com/sign-in" target="_blank" data-type="admin" data-icon="🛂" data-desc="Booking .com Extranet." data-manual="Link to the Booking.com login page for WET.">B.com Login</a>` +
                    `<a href="https://inbox.hostelworld.com/" target="_blank" data-type="admin" data-icon="🛂" data-desc="HW Extranet." data-manual="Link to the&nbsp;Hostelworld&nbsp;login page for WET.">HW Login</a>`;
    ...
    if (['BOSS', 'REC', 'OA'].includes(user)) {
        let items = `<a href="https://sg.loventis.net/Reception" target="_blank" data-type="booking" data-icon="🏩" data-desc="Reservation management (PMS)." data-manual="Check-in/out guests.">Loventis (PMS)</a>` +
                    ...
                    `<a href="${fix('https://loren-6q.github.io/WETParser/')}" data-type="booking" data-icon="📑" data-desc="Clean AirBnB, B.com and CC data." data-manual="Robust parsing app that can pull important information out of copy/paste from AirBnB, Booking.com, and MyAllocator credit card info.<div><br></div><h3>💳CC PARSER</h3><div><ul><li>Copy &amp; paste credit card data from MyAllocator</li><li>Strips junk and gives Name, Card #, Expiry date, and if available, CVV &amp; Billing Address/Zip Code</li></ul><h3>📘BOOKING.COM PARSER</h3></div><div><ul><li>Load a booking on Booking.com</li><li>Click 'show Phone Number' if needed</li><li>Copy the entire first box, from <b>'Check In'</b> to any <b>'Important information about this guest'</b></li><li>Paste into the parse box. It will generate info broken down &amp; a summary to paste into the booking notes</li><li>You can click any box to copy it</li></ul><div><h3>🛏AIRBNB PARSER</h3><div><ul><li>Load a booking on AirBnB</li><li>Copy from the guest name to the end of the Host Payout section</li><li>Paste into the parse box. It will generate info broken down &amp; a summary to paste into the booking notes</li><li>You can click any box to copy it</li></ul><h3>💬AIRBNB QUOTE GENERATOR</h3><div><ul><li>Click the 🗨 icon in the top right navigation to generate a full price quote for an AirBnB request</li><li>Cut &amp; paste the same section as above from AirBnB</li><li>In the top row you can adjust the number of guests or nights in the top row</li><li>Click the <b>WET Rates</b> button, and it will open Booking.com</li><li>Select all, copy, and close the Booking.com window</li><li>Click paste, and it will fill the parsing box</li><li>Click <b>Extract Price,</b> and it will fill the prices of all room types (adjust if needed)</li><li>The app will calculate the price for all the beds, as well as the price for blocking a dorm for private use</li><li>The private dorm feature is not working for more than 8 guests currently</li><li>If the booking is less than 3 days, the tool adds text about the 5-day Full Moon Week</li></ul></div></div></div></div>">Parser</a>`;
    ...
    if (['BOSS', 'REC', 'OA', 'BAR'].includes(user)) {
        ...
        items += `<a href="https://inbox.myallocator.com/booknow/-sxO1cCV5jLMwqZTXY629A" target="_blank" data-type="quotes" data-icon="🏨" data-desc="Direct booking engine rates." data-manual="This is just a link to WET's direct booking page for the discounted direct pricing. The <b><u>PRICER</u></b> app can also calculate the direct price discount without using this.">WET Booking Engine</a>`;
        if (['BOSS', 'REC', 'OA'].includes(user)) {
            items += `<a href="https://www.booking.com/searchresults.en-gb.html?dest_id=900050772" target="_blank" data-type="quotes" data-icon="🔵" data-desc="Standard B.com search." data-manual="This is just a link to Booking.com's search page for Haad Rin to compare prices with other properties. The <b><u>PRICER</u></b> app is more useful than this link.">B.com Search</a>` +
                     `<a href="https://www.hostelworld.com/pwa/s?q=Koh%20Phangan" target="_blank" data-type="quotes" data-icon="🟠" data-desc="Hostelworld search." data-manual="This is just a link to Hostelworld's search page for Haad Rin to compare prices with other properties. The <b><u>PRICER</u></b> app is more useful than this link.">HW Search</a>` +
                     `<a href="https://www.booking.com/hotel/th/wet-pool-party-haad-rin.html" target="_blank" data-type="quotes" data-icon="🔗" data-desc="Direct link to WET on B.com." data-manual="This is just a link to the WET listing on Booking.com.&nbsp;The&nbsp;<b><u>PRICER</u></b>&nbsp;app is more useful than this link.">WET on B.com</a>` +
                     `<a href="https://www.hostelworld.com/pwa/hosteldetails.php/WET-a-Pool-Party-Hostel-by-Wild-Wandering/Koh-Phangan/313418" target="_blank" data-type="quotes" data-icon="🔗" data-desc="Direct link to WET on HW." data-manual="This is just a link to the WET listing on Hostelworld.&nbsp;The&nbsp;<b><u>PRICER</u></b>&nbsp;app is more useful than this link.">WET on HW</a>`;
        }
        html += `<div class="nav-item"><span class="drop-btn">Quotes ▾</span><div class="dropdown-content">${items}</div></div>`;
    }

    if (['BOSS', 'REC', 'OA'].includes(user)) {
        let items = `<a href="${fix('https://loren-6q.github.io/WETvCal/')}" data-type="staffing" data-icon="🗓️" data-desc="Calendar for stay dates of temp workers." data-manual="Calender of when Temp Workers are staying at WET. This is not a work schedule, just a stay calendar.">V Cal</a>` +
                    `<a href="${fix('https://staff-scheduler.onrender.com/')}" target="_blank" data-type="staffing" data-icon="📅" data-desc="Schedule part-time staff roster." data-manual="Temp Workers scheduling app. This is a VERY complex and robust all to create a balanced schedule with even number of hours and even distribution of tasks. There is the ability to add days, restrict which tasks are available, and assign individual staff members more of (or ONLY) one task.">Scheduler</a>`;
    ...
    if (['BOSS', 'BAR', 'REC', 'OA', 'HK'].includes(user)) {
        let items = "";
        if (['BOSS', 'REC', 'BAR'].includes(user)) items += `<a href="#" data-type="ops" data-icon="💳" data-desc="Point of sale for bar and shop." data-manual="(Coming Soon) Point of sale system for every work station at WET">POS</a>`;
        if (['BOSS', 'REC', 'BAR', 'OA'].includes(user)) items += `<a href="${fix('https://bar-stock-nine.vercel.app/')}" data-type="ops" data-icon="🍺" data-desc="Inventory and stock check." data-manual="Stock count for bar and hostel supplies">Stock</a>`;
        if (['BOSS', 'OA'].includes(user)) items += `<a href="${fix('https://loren-6q.github.io/Full-Moon-Week-Schedule/')}" data-type="ops" data-icon="🌕" data-desc="FMW Instagram publishing tool." data-manual="Scheduling app for Full Moon Week Instagram. There is a large manual for this already, integrated soon.">FMW</a>`;
        if (['BOSS', 'REC', 'HK'].includes(user)) items += `<a href="${fix('https://loren-6q.github.io/WETDoors/')}" data-type="ops" data-icon="🔒" data-desc="Room access and security locks." data-manual="Very simple app that has all the codes for all the dorm door locks at WET.&nbsp;<div><ul><li>Displays every room and code</li><li>Can select 100, 200, or 300 to filter by different areas</li><li>Click any room to edit the code and save</li></ul></div>">Doors</a>`;
