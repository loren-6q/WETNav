...
const renderNav = () => {
    ...
    if (user === 'BOSS') {
        let items = `<a href="${fix('https://loren-6q.github.io/WETAccounting/')}" data-type="accounting" data-icon="🏦" data-desc="WET overall accounting." data-manual="Company ledger.">Accounting</a>` +
